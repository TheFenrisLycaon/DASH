...
from src.utils.hls_utils import HLSKeyInfoFile
from src.utils.utils import get_time, time_left


def p_open(commands, **options):
    """
...
class Process(object):
    ...
    def __init__(self, media, commands: str, monitor: callable = None, **options):
        ...
        self.process = p_open(commands, **options)
        self.media = media
